...
static void gouraudLineSetup(myreal * redstep, myreal * greenstep, myreal * bluestep, int length, COLOR table1, COLOR table2, u8* ram, Vdp1* regs, vdp1cmd_struct * cmd, u8 * back_framebuffer) {
